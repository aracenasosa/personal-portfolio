    ...
    return (
        <FadeInSection>
            <section id="reviews" className="mb-32">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold mb-12">What Clients Say About Me</h2>
                ...
                <div className="relative">
                    ...
                    <div className="bg-card border border-border/50 rounded-3xl p-8 md:p-12">
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div className="flex-1">
                                <div className="mb-4">
                                    <h3 className="text-xl font-bold mb-1">{currentReview.name}</h3>
                    ...
                    <div className="flex gap-3 mt-8">
                        <button
                            onClick={prevReview}
                            className="w-12 h-12 rounded-full border border-border/50 bg-background hover:bg-secondary transition-colors flex items-center justify-center"
