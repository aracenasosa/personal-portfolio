...
// Using correct non-deprecated Lucide icons
const iconMap = {
    github: () => (
    ...
    return (
        <div className="sticky top-8 h-fit flex flex-col gap-6 p-8 rounded-3xl bg-card border border-border/50 shadow-xl">
            <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-medium text-muted-foreground">{profileInfo.title}</span>
            </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="font-medium">{profileInfo.specialization}</p>
            </div>
